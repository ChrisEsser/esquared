...
<head>
    ...
    <link rel="stylesheet" href="/css/betterButtons.css?ver=108"/>
    <link rel="stylesheet" href="/css/style.css?ver=108"/>
    ...
    <script src="/js/confirm.js?ver=108"></script>
    <script src="/js/filepondHelper.js"></script>
    <script src="/js/tableData.js?ver=108"></script>
    <?= HTML::displayHead() ?>
</head>
