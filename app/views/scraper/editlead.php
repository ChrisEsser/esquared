...
<form id="LeadForm">
    ...
    <input type="hidden" name="lead" value="<?=$lead->lead_id?>" />

    <div class="mb-3">
        <label for="street" class="form-label">Street</label>
        <input type="text" class="form-control" id="street" name="street" aria-describedby="streetHelp" autocomplete="off" required value="<?= $lead->street ?>"/>
    </div>

    <div class="mb-3">
        <label for="city" class="form-label">City</label>
        <input type="text" class="form-control" id="city" name="city" aria-describedby="cityHelp" autocomplete="off" value="<?= $lead->city ?>"/>
    </div>
    ...
    <div class="row">
        ...
        <div class="mb-3 col-6">
            ...
            <input type="text" class="form-control" id="state" name="state" aria-describedby="stateHelp" autocomplete="off" value="<?= $lead->state ?>"/>
        </div>

        <div class="mb-3 col-6">
            <label for="zip" class="form-label">Zip</label>
            <input type="text" class="form-control" id="zip" name="zip" aria-describedby="zipHelp" autocomplete="off" value="<?= $lead->zip ?>"/>
        </div>
